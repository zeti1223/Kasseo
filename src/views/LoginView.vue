...
<template>
  <div
    ...
    style="min-height: 100vh; background: radial-gradient(circle at 20% 20%, #C8A5FC 0%, #A78BCA 60%, #8B6FA8 100%)"
  >
    <div class="bg-white dark:bg-surface-dark rounded-lg p-8 shadow-lg max-w-[380px] w-full mx-4">
      <div class="text-center mb-6">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">
          Log shared deposits and expenses with the people you split a fund with, in real time.
        </p>
      </div>
      <button
        @click="handleLogin"
