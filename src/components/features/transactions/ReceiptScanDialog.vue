...
<template>
  ...
  >
    ...
    <div
      class="relative bg-white dark:bg-surface-dark rounded-t-2xl sm:rounded-2xl shadow-xl p-5 sm:p-6 w-full max-w-none sm:max-w-[480px] max-h-[90vh] overflow-y-auto pb-[max(1.5rem,env(safe-area-inset-bottom,0px))] sm:pb-6"
    >
      ...
      <div class="flex items-center justify-between mb-4">
        ...
        <button
          @click="close"
          class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 w-8 h-8 rounded-lg flex items-center justify-center -mr-2"
        >
