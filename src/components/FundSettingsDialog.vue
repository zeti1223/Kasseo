  ...
  >
    ...
    >
      ...
      <div v-if="activeTab === 'members'" class="space-y-4">
        <div
          class="bg-[#A5E3FC]/20 border border-[#A5E3FC] rounded-lg p-3 mb-4"
        >
          <div class="flex items-center justify-between">
            <div>
          ...
          >
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <div
                  v-if="member.id === props.group?.ownerId"
        ...
        >
          ...
          />
          <div
            class="relative bg-white dark:bg-surface-dark rounded-lg shadow-lg p-6 w-full max-w-[400px] mx-4"
          >
      ...
      <div v-if="activeTab === 'categories'" class="space-y-4">
        ...
        <div
          v-if="showRemoveCategoryConfirm"
          class="fixed inset-0 z-60 flex items-center justify-center"
        >
          <div
            class="absolute inset-0 bg-black/50"
