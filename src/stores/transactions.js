...
import { ref } from 'vue'
import { ref as dbRef, push, set, remove, onValue, serverTimestamp } from 'firebase/database'
...
export const useTransactionsStore = defineStore('transactions', () => {
  ...
  async function addTransaction(groupId, { amount, type, category, description, date }) {
  ...
  async function updateTransaction(groupId, txId, { amount, type, category, description, date, paidBy }) {
  ...
  return { transactions, listen, stop, addTransaction, deleteTransaction, updateTransaction }
})
